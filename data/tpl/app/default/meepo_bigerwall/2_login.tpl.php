...
<script type="text/javascript" src="<?php echo RES;?>files/js/semantic.min.js"></script>
<link rel="stylesheet" href="<?php echo RES;?>files/css/semantic.min.css" type="text/css">
...
<link href="<?php echo RES;?>files/css/flat-ui.css?t=<?php  echo time();?>" rel="stylesheet">
<link href="<?php echo RES;?>css/login.css?t=<?php  echo time();?>" rel="stylesheet">
</head>
<body style="width:100%;height: 100%;">
<style type="text/css">
<?php  if(empty($ridwall['login_bg'])) { ?>
body{background: url(<?php echo RES;?>css/bg.gif) center 0 no-repeat;}
<?php  } else { ?>
body{background: url(<?php  echo $_W['attachurl'];?><?php  echo $ridwall['login_bg'];?>) center 0 no-repeat;}
<?php  } ?>
</style>
<?php 
	$check = $this->docheckurl();
				 ...
				 if($check){
				   echo "<div style='color:red;font-size:40px;'>NO pass</div>";
				 }
...
<div class="container" style="width:60%">
        <div class="login-screen">
          <div class="login-icon col-xs-3 hidden-sm hidden-xs">
            <img src="<?php echo RES;?>files/images/icons/png/Gift-Box.png" alt="" />
          ...
          <div class="login-form" style="background-color:#fff">
            ...
            <a class="login-link" href="#" target="_blank"><strong>Powered by:<?php  echo $ridwall['votepower'];?></strong></a>
			<style>
